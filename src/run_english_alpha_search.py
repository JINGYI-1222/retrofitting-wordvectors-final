...
OUTPUT_CSV     = RESULTS_DIR / "alpha_search_simlex_results.csv"
OUTPUT_LOG     = RESULTS_DIR / "alpha_search_simlex_summary.txt"
OUTPUT_PLOT    = RESULTS_DIR / "alpha_search_simlex_curve.png"
...
def main():
    ...
    fieldnames = ["alpha", "beta_strategy", "dataset", "original_rho",
